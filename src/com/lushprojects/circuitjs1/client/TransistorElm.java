...
//		sim.console("gmin " + gmin + " vbc " + vbc + " vbe " + vbe);
	    ...
	    // add minimum conductance (gmin) between b,e and b,c.  Note, ie/ic/ib calculated above doesn't include the current
	    // generated by this extra conductance.  This may cause bad currents if the transistor is constantly having
	    // trouble converging.
	    gcc -= gmin;
	    gee -= gmin;
